...
const RefundDetails = () => {
    ...
    const requestedAt = refundData.requestedAt ? new Date(refundData.requestedAt).toLocaleString() : "Not specified";
                            ...
                            <div className="card-body">
                                ...
                                <ul className="dm-info p-0 m-0">
                                    ...
                                    <li className="align-items-center">
                                        ...
                                        <span>:</span>
                                        <span className="right">
                                            <Link to={`/orderdetail/${refundData.order?._id || "#"}`} className="badge py-2 badge-soft-primary border border-primary px-2">
                                                View details
                                            </Link>
                                        </span>
                                    </li>
                                ...
                                <div className="refund-details">
                                    ...
                                    <ul className="dm-info p-0 m-0 w-l-115">
                                        <li>
                                            ...
                                            <span>:</span>
                                            <span className="right"><strong>{product.quantity || 0}</strong></span>
                                        </li>
                                        <li>
                                            <span className="left">Total price</span>
                                            <span>:</span>
                                            <span className="right"><strong>${totalAmount}</strong></span>
                                        </li>
                                        <li>
                                            <span className="left">Total discount</span>
                                            <span>:</span>
                                            <span className="right"><strong>${discountAmount}</strong></span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span>:</span>
                                            <span className="right"><strong>${taxAmount}</strong></span>
                                        </li>
                                        <li>
                                            <span className="left">Subtotal</span>
                                            <span>:</span>
                                            <span className="right"><strong>${refundableAmount}</strong></span>
                                        </li>
                                        <li>
                        ...
                        <div className="card h-100 refund-details-card--2">
                            <div className="card-body">
                                ...
                                <div className="gallery grid-gallery">
                                    {refundImages.length > 0 ? refundImages.map((img, index) => (
                                        <a href="#" data-lightbox="mygallery" className="d-flex" key={index}>
                                            <img src={img.url} width="65" height="65" alt="Refund Image" />
                                        </a>
                                    )) : (
