...
const WebsiteColorCard = () => {
  const [primaryColor, setPrimaryColor] = useState('#1455AC');
  const [secondaryColor, setSecondaryColor] = useState('#F58300');
    ...
    <div className="card h-full w-full md:w-2/4 border border-gray-300 rounded-lg shadow-lg">
      <div className="card-header p-3 bg-white shadow-md ">
        <h5 className="mb-0 text-sm font-bold  flex items-center gap-2">
          <img src="https://6valley.6amtech.com/public/assets/back-end/img/website-color.png" alt="Website Color" />
          Website Color
        </h5>
      </div>
