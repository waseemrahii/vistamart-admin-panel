  ...
  useEffect(() => {
    const fetchTermsAndConditions = async () => {
      try {
        ...
        const terms = response.data.doc.find(page => page.name === "Refund Policy");
        if (terms) {
...
//   if (!termsFound) {
//     toast.warn("Refund Policy not found. Please create one.");
//   }
        ...
        <FormSection title="">
          <div className="flex flex-col ">
            ...
            <ReactQuill
              ...
              theme="snow"
              placeholder="Write the ReRefund Policy..."
            />
          </div>
        </FormSection>
