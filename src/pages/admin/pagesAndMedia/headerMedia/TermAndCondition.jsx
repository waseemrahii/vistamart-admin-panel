  ...
  useEffect(() => {
    const fetchTermsAndConditions = async () => {
      try {
        ...
        const terms = response.data.doc.find(page => page.name === "Terms and Conditions");
        if (terms) {
      ...
      <form onSubmit={handleSubmit}>
        <FormSection title="">
          <div className="flex flex-col ">
            <label className="font-semibold">Term And Conditions</label>
            <ReactQuill
              name="description"
              ...
              theme="snow"
              placeholder="Write the Term And Condition..."
            />
          </div>
        </FormSection>
