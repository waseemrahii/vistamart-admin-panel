...
//// set for both thumbnail and images/// not for new iamges
// const uploadProductImagesToS3 = async (thumbnail, images, initialThumbnail, maxRetries = 3) => {
...
//         // Use the existing thumbnail key if no new thumbnail is uploaded
//         thumbnailKey = initialThumbnail;
//     }
...
// it adding the new image with privouse 
...
//     for (const img of images) {
//         if (img.file && !initialImages.some((existingImg) => existingImg?.file === img.file)) {
//             try {
//                 const imageConfig = await getProductUploadUrl(img.file.type, folder);
//                 imageUploadConfigs.push({ type: "image", config: imageConfig, file: img.file });
//             } catch (error) {
