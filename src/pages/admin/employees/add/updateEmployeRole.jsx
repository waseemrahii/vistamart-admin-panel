...
//             if (response.ok) {
//                 console.log("response ofo getiing ", data)
//                 setRoleName(data?.doc?.name);
//                 setSelectedModules(data?.doc?.modules);
//             } else {
...
//         'dashboard', 'Order management', 'Refund management', 'Category management',
//         'Brand management', 'Product attribute', 'Inhouse Product', 'Vendor management',
//         'Vendor product', 'Banner setup', 'Offer and deals', 'Notifications', 'Announcement',
//         'Inbox', 'Message', 'Sales and transaction', 'Product report', 'Order report',
//         'Customer management', 'Delivery management', 'Employee management', 'Subscribers',
//         'Business setup', 'System setup', 'ThirdParty', 'Page and media',
//     ];
...
//                     <form id="submit-update-role" className="text-start" onSubmit={handleFormSubmit}>
//                         <div className="row">
