...
const IndexMessage = () => {
  return (
    <>
      <div className="bg-secondary-500 w-full h-full p-5">
          ...
          <div className="bg-white h-[80vh] w-60 rounded-lg">
            <form className="relative pt-5 pl-2 pr-2 justify-center">
              {/* <input
                ...
                placeholder="Search..."
                aria-label="Search"
                className="w-full px-3 py-2 font-semibold bg-[#EBEDF1] placeholder-gray-500 text-black rounded-lg border-none ring-2 ring-gray-300 focus:outline-none focus:ring-primborder-primary-500 focus:border-primary-500"
              /> */}
              ...
              <input
                ...
                className="border-2 border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:border-primary-500"
              />
            </form>
            <div className="h-full">
              ...
              <div>
                <p className="text-[#0177CD] pt-8 pl-6 font-semibold border-primary-500 mb-4">
                  Customer
                </p>
                <p className="border-b-4 border-primary-500 mb-6 mr-24 ml-5"></p>
